<script lang="ts">
	...
	import Community from '../utils/utils/icons/Community.svelte';
...
<Section class="lg:py-24">
	...
	<div class="mx-auto flex w-full max-w-7xl flex-col items-center gap-12">
		...
		<div class="flex max-w-2xl flex-col items-center justify-center gap-4">
			<h2
				class="text-center text-3xl font-extrabold tracking-tight text-gray-900 lg:text-4xl dark:text-white"
			>
				Community contributors
			</h2>
			<p class="text-center text-lg font-normal">
				Join the open-source community by contributing to the Flowbite Svelte Library and become one
		...
		<div class="flex w-full max-w-5xl flex-row items-center justify-between lg:px-4">
			<div
				class="flex w-full flex-col items-start justify-between gap-4 rounded-lg bg-gray-50 p-4 sm:flex-row sm:items-center sm:gap-8 dark:bg-gray-800"
			>
				...
				<a
					class="text-primary-700 flex items-center gap-2 whitespace-nowrap text-base font-medium hover:underline"
