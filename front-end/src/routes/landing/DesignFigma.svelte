<script>
	...
	import Figma from '../utils/utils/icons/Figma.svelte';
	import FlowbiteLogo from '../utils/utils/icons/FlowbiteLogo.svelte';
	...
	<div class="grid grid-cols-1 justify-between py-1 lg:grid-cols-2">
		<div class="flex max-w-lg flex-col gap-8">
			<div class="flex flex-col items-start gap-6">
				<h2 class="text-3xl font-extrabold leading-none text-gray-900 lg:text-4xl dark:text-white">
					Design with Figma
				</h2>
				<p class="text-lg">
					Track work across the enterprise through an open, collaborative platform. Link issues
					across Jira and ingest data from other software development tools.
				</p>
			</div>
