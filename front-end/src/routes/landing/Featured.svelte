<script lang="ts">
	import Dev from '../utils/utils/icons/Dev.svelte';
	import Reddit from '../utils/utils/icons/Reddit.svelte';
	import YouTubeFull from '../utils/utils/icons/YouTubeFull.svelte';
	import Hunt from '../utils/utils/icons/Hunt.svelte';
	import Combinator from '../utils/utils/icons/Combinator.svelte';
