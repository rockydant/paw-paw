    ...
    <div class="flex items-center gap-8">
      <div class="flex flex-col justify-start gap-10">
        <div class="flex flex-col gap-4 lg:gap-6 text-left">
          <h1 class="text-4xl lg:text-6xl leading-none font-extrabold text-gray-900 dark:text-white max-w-2xl">
            <span class="block1 xl:inline">We live and breathe</span>
            <span class="block1 text-primary-700 dark:text-primary-700 xl:inline">Books</span>
          </h1>
          <p class="text-lg lg:text-xl leading-normal text-gray-500 dark:text-gray-400">Books are Friends That Never Leave. Read, Dream, Repeat.</p>
      ...
      <div class="p-0 hidden xl:block">
        ...
        <div class="hidden relative dark:block">
          <img class="max-w-xl -me-7" src="/images/open-book.png" alt="Header" />
        </div>
      </div>
    </div>
  </div>
